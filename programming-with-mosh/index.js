...
console.log(name);
let something1 = 1,
  something2; // but best practice, keep variables on separate lines
...
let bill; // or "=undefined"; Undefined (val doesn't exist in compiler); undefined is both a TYPE and VALUE
let sally = "null"; // null (explicitly and intentionally clear value of variable for later)
...
function greet(name, lastName) {
  // "name" is a PARAMETER to "greet" function (only useful within this function)
